...
export default {
  data: function() {
    return {
      ...
      displayCode : false,
      range : 100,
      cssProperty : 'background : linear-gradient(90deg, rgb(0, 204, 203)' + this.range + '%, transparent ' + 100 + '%)'
    };
  },
  name: 'Home',
  components: {
  ...
  methods:{
    ...
    updateRange : function () {
      ...
      this.cssProperty = 'background : linear-gradient(90deg, rgb(0, 204, 203)' + this.range + '%, transparent ' + 100 + '%)'
